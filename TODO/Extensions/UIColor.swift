...
extension UIColor {
    ...
    static let vitInterface = UIColor.rgb(r: 79, g: 52, b: 11)
    
    static let alexeyBackground = UIColor.rgb(r: 82, g: 149, b: 139)
    static let alexeyFog = UIColor.rgb(r: 185, g: 196, b: 201)
    
    static let alexeyInterface = UIColor.rgb(r: 185, g: 196, b: 201)
//    static let alexeyText = UIColor.rgb(r: 45, g: 200, b: 180)
    ...
    static let alexanderBackground = UIColor.rgb(r: 112, g: 112, b: 112)
